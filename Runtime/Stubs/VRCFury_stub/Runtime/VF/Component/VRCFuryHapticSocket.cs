...
namespace VF.Component
{
  ...
  public class VRCFuryHapticSocket : VRCFuryComponent
  {
    ...
    public bool IsValidPlugLength => enablePlugLengthParameter && !string.IsNullOrWhiteSpace(plugLengthParameterName);
    public bool IsValidPlugWidth => enablePlugWidthParameter && !string.IsNullOrWhiteSpace(plugWidthParameterName);
