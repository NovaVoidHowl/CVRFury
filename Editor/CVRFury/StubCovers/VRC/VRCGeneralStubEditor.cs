...
{
  public abstract class VRCGeneralStubEditor : Editor
  {
    protected virtual string componentTypeSuffix => "Unknown";
    ...
    public override VisualElement CreateInspectorGUI()
    {
      ...
      var baseTree = Resources.Load<VisualTreeAsset>(
        Constants.PROGRAM_DISPLAY_NAME + "/StubCovers/UnityUXML/VRCGeneralStub"
      );
      ...
      var stylesheet = Resources.Load<StyleSheet>(
        Constants.PROGRAM_DISPLAY_NAME + "/StubCovers/UnityStyleSheets/VRCGeneralStub"
      );
      ...
      {
        CoreLogError(
          "Failed to load StyleSheet at 'UnityStyleSheets/VRCGeneralStub'. Please ensure the file exists at the specified path."
        );
